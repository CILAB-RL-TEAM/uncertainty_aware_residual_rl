...
class SACAgent(flax.struct.PyTreeNode):
    ...
    def critic_loss_fn(self, batch, params: Params, rng: PRNGKey):
        ...
        complete_action = next_actions + batch["next_base_actions"]
        complete_action = jnp.clip(complete_action, -1, 1)

        # Evaluate next Qs for "complete" actions
        ...
        ## batch["actions"] are the actions taken by the current policy + base actions
    ...
    def policy_loss_fn(self, batch, params: Params, rng: PRNGKey):
        ...
        # The assymteric actor critic approach
        # queries the critic with the complete action
        complete_action = actions + batch["base_actions"]
        complete_action = jnp.clip(complete_action, -1, 1)
    ...
    def create(
        ...
        **kwargs
        ...
        """
        if "add_ba_state_in_actor" in kwargs.keys() and kwargs["add_ba_state_in_actor"] is True:
    ...
    def update_critics_state(
        ...
        *,
        ...
        agent, critic_infos = self.update(
                batch, 
                pmap_axis=pmap_axis,
