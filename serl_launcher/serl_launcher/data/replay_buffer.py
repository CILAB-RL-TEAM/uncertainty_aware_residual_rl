...
class ReplayBuffer(Dataset):
    def __init__(
        ...
        dataset_dict = dict(
            ...
            base_actions=np.empty((capacity, *action_space.shape), dtype=action_space.dtype),
            base_action_stds=np.empty((capacity, *action_space.shape), dtype=action_space.dtype),
            next_base_actions=np.empty((capacity, *action_space.shape), dtype=action_space.dtype),
            next_base_action_stds=np.empty((capacity, *action_space.shape), dtype=action_space.dtype),
            next_base_log_prob=np.empty((capacity,), dtype=np.float32),
